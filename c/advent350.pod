...
Users can circumvent cave "prime time" hours and game restoration delays by
...
spaces or cause the line to reach MAX_INPUT_LENGTH characters (default 80).

If ADVMAGIC was defined at compile time, the original messages about saving
your core image are still printed out when saving a game and after changing the
"magic" values, despite the fact that these messages are now irrelevant and
misleading.
...
Wodder II <jwodder@sdf.lonestar.org> after he became dissatisfied with the C
