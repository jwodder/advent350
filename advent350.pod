...
If the user enters a line MAX_INPUT_LENGTH (default 80) or more characters
...
saving your game (if ADVMAGIC was defined at compile time) and after changing
the "magic" values, despite the fact that these messages are now irrelevant and
misleading.
